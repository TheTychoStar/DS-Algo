...
print("=====panda======")
df = pd.read_csv("https://data.ontario.ca/dataset/5472ffc1-88e2-48ca-bc9f-4aa249c1298d/\
resource/d5d8f478-765c-4246-b8a7-c3b13a4a1a41/download/outbreak_cases.csv")
print(df.head())
print(df.shape)
print(df.columns)
print(df.dtypes)
...
df.groupby(["category_grouped"]).sum().plot.pie(
    y="TOTAL_CASES", autopct="%1.1f%%",
    textprops={"color": "b"}, figsize=(10, 10))
